...
public class GetSingleOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            selectedOrder = classicmodelsPool.findOrdersByOrderNum(Integer.valueOf(orderNum));
        } catch (Exception e) {
            System.out.println("Error while finding specific order: " + orderNum);
            System.out.println(e.getLocalizedMessage());
        }
        
        
        out.println(selectedOrder.toJson().toJSONString());
