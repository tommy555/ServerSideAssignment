...
public class Orderdetails implements Serializable {
    ...
    public JSONObject toJson() {
        ...
        jobj.put("orderNumber", orderdetailsPK.getOrderNumber());
        jobj.put("productCode", orderdetailsPK.getProductCode());
        jobj.put("quantityOrdered", quantityOrdered);
        jobj.put("priceEach", priceEach);
        jobj.put("orderLineNumber", orderLineNumber);
        return jobj;
    }
